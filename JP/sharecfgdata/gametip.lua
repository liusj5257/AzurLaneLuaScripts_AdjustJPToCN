...
_G.pg.base.gametip.world_boss_help_meta = {
	tip = {
		{
			info = [[
<color=#92fc63>2024.6.13-2024.9.5</color>
META戦・ウィチタ(META)が開催中です。META戦で解析Ptを集め、META艦船を手に入れましょう。
...
_G.pg.base.gametip.retire_setting_help = {
	tip = {
		{
			info = [[
 ·「誤退役防止確認」をONにすると、退役対象となる艦船でドック内に<color=#92fc63>ほかの同名艦船が存在しない</color>場合、退役確認画面が表示されるようになります
 ·一括退役について：
  1.レアリティがSR、R、N
  2.ロック（保護）状態ではない
  3.レベルが1
...
※<color=#92fc63>2024.6.13-2024.9.5</color>ウィチタ(META) META戦開放期間は「ウィチタ・META」の解析Ptを入手できます。
