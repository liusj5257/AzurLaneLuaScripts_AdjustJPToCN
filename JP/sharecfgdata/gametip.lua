...
_G.pg.base.gametip.world_boss_help = {
	tip = {
		...
		{
			info = "イベント「新春宴会狂騒曲」とは、<color=#92fc63>「演習Pt」</color>を集めて作戦進捗を進めると、個人累計Pt報酬と作戦進捗報酬が得られるイベントになります。"
		},
		{
			info = [[
...
_G.pg.base.gametip.help_music_game = {
	tip = {
		...
		{
			info = [[
「ミニゲーム（饅頭ステージ）」とは、リズムゲームを遊び「共鳴ノード」を貯めるミニゲームになります。
...
「共鳴ノード」を貯められる回数はイベント開始後1日ごとに1回増加します。]]
		...
		{
			info = [[
・画面スライドで曲を選び、さらに難易度を選んで画面右下の「スタート」をタップすると、リズムゲームを開始することができます。
...
・「年玉」は「撫順の大冒険Ⅴ」「おえかき」「花火迎新春」「飛雲の新春冒険」を遊ぶことで入手できます。
・入手した「年玉」は15個目までは「年玉・大」になります。
・入手した「年玉」を開封する際は「年玉・大」から優先的に開封されます。
開封すると、ダイヤなどの報酬をランダムで獲得できます。
また、「年玉」を累計15個開封すると、<color=#92fc63>「撫順」の着せ替え（復刻）</color>を入手できます。「年玉」を累計25個開封すると、<color=#92fc63>「若月」の着せ替え（新規）</color>を入手できます]]
		}
	}
}
...
_G.pg.base.gametip.shan_luan_task_help = {
	tip = {
		{
			info = [[
開催期間：<color=#92fc63>11.23-12.7 メンテまで </color>
...
_G.pg.base.gametip.senran_pt_help = {
	tip = {
		{
			info = [[
開催期間：<color=#92fc63>11.23-12.7 メンテ </color>
...
_G.pg.base.gametip.help_chunjie2024 = {
	tip = {
		{
			info = [[
開催期間：<color=#92fc63>2024.1.30-2024.2.22メンテまで</color>
遊び方：
...
_G.pg.base.gametip.idol3rd_houshan = {
	tip = {
		...
		{
			info = "共鳴のパッションとは、イベント「共鳴のパッション」のトップページであり、イベントの各画面に移動することができます。\n"
		},
		{
			info = [[
■各コンテンツの説明
...
ショップ：
「共鳴のパッション」を各種報酬と交換することができます。
 
累計報酬：
入手した「共鳴のパッション」の累計数により、艦船「ル・テメレール（μ兵装）」など様々な報酬を入手できます。
限定建造：
建造の「期間限定建造」ページに移動します。
