...
・META戦では上記①と②のいずれでも、敵が撃破された（HPが0になった）時、戦闘に参加した指揮官全員「解析Pt」が入手することが出来ます。

■注意
・開放された戦闘は24時間挑戦できます。24時間を経過した場合META戦の表示が消失し、挑戦できなくなります。
...
_G.pg.base.gametip.world_boss_help = {
	tip = {
		...
		{
			info = [[
イベント期間中、アルビオンたちが率いる艦隊を相手に戦う「演習作戦」特別ステージが登場します。
...
・2022年9月15日（木）～10月13日（木）メンテナンスまでに一度でもログインしたことがある上記の条件を満たしていない場合は「カムバック・新人指揮官」として、専用任務をクリアすることで報酬を入手することができます。
...
■コラボイベント
・11.25-12.9の間、コラボイベント限定海域が開放され、「弧光結晶」を入手できます。
・「弧光結晶」は累計入手数報酬のほか、ショップにて様々な報酬と交換できます。
・また、イベント海域ではSSR「飛鳥川ちせ」、コラボ装備外装箱を入手できます。

■スペシャルログインボーナスについて
・キャンペーンページの画面右下のコントローラーをタップで、SDキャラを移動させることができ、踏んだマスによって報酬を入手できます。
・キャンペーン期間中（11.25-12.9）、毎日移動可能回数が5回加算されます。
・ログインボーナスキャンペーンでは、限定家具や「弧光結晶」を入手できます。

■ミニゲームについて
・ミニゲーム「激闘！電光饅頭VS怪獣饅頭」は12.1まで毎日新しい進捗が開放されます。
・ミニゲームを7日間プレイし、最後まで進捗させると、兵装「輝きのブレスレット」を入手できます。
・ミニゲームでは、限定家具を入手できます

■記念章について
・記念章ページの各種実績を達成すると、セイレーンのプロフィール紹介が開放されます。
・プロフォールを全開放（全実績達成）すると、記念家具「SSSS記念章」を入手できます。]]
		}
	}
}
...
ミニゲームは12.1（水）まで毎日新しいゲームが開放され、クリアすると装備外装箱や弧光結晶、限定家具を入手できます。
	...
	tip = {
		{
			info = [[
■概要
記念章キャンペーン「アカネのコレクション」とは、様々な実績を達成することでセイレーン情報を開放でき、セイレーン情報を全部開放すると、コラボ参加記念アイテム「SSSS記念章」を入手できます。

「SSSS」記念章は12.15（水）23:59まで入手できます。]]
		}
	}
}
...
・「指揮官祈願」回数を所持している状態で、幸運祈願画面右上のボタンをタップすることで、指揮官祈願を行うことができます
・「指揮官祈願」を行うと、3種類の強化効果から1個を選び、一定時間に艦隊に付与できます
　※指揮官祈願による艦隊強化効果は同時に1種類しか適用できず、新たに指揮官祈願を行った場合、前の効果が上書きされます。]]
		}
	}
}
	...
	tip = {
		{
			info = [[
■概要
「撫順の大冒険Ⅲ」とは、画面右へと進み続ける撫順を操作し、障害物や隙間を避けながら敵を倒していき、スコアを稼ぐミニゲームです。

2/2（水）まで毎日ゲーム回数が1回加算され、ゲーム回数を所持している状態でクリアすると、ゲーム回数が1回消費されます。ゲーム回数を消費すると、報酬を入手できます。また、ゲーム回数を7回消費すると、駆逐艦「撫順」を入手できます。
...
_G.pg.base.gametip.littleChaijun_npc = {
	tip = {
		...
		{
			info = "4.友好度報酬は6/2（月）まで毎日1段階ずつ解放されます。"
		},
		{
...
_G.pg.base.gametip.summerland_tip = {
	tip = {
		{
			info = [[
■概要裏山会場とは、期間限定で開催するキャンペーンページになります。開催期間は<color=#92fc63>2022.8.18-2022.9.1</color>になります
